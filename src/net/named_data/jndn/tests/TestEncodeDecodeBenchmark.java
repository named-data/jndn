...
public class TestEncodeDecodeBenchmark {
  ...
  benchmarkEncodeDecodeData(boolean useComplex, boolean useCrypto) throws EncodingException
  {
    ...
    {
      int nIterations = useCrypto ? 1000 : 5000000;
    ...
    {
      // Use an extra long duration for decoding until we understand why it gets a different rate at a shorter durations.
      int nIterations = useCrypto ? 1000 : 40000000;
